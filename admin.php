...
$sqlfolio = "SELECT * FROM usuariovisa where usuario='".$_SESSION['usuario']."' limit 1";
...
$sql = "SELECT * FROM usuariovisa  limit 200";
...
background: -moz-linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(221,9,23,1) 31%, rgba(255,0,0,1) 96%);
background: -webkit-linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(221,9,23,1) 31%, rgba(255,0,0,1) 96%);
background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(221,9,23,1) 31%, rgba(255,0,0,1) 96%);
